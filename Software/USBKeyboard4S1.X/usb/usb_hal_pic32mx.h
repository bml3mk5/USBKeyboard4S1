...
//restore operations (such as prior to and after entering sleep on suspend).
    ...
    #define DEVICE_SPECIFIC_IEC_REGISTER_COUNT 2   //Number of IECx registers implemented in the microcontroller (varies from device to device, make sure this is set correctly for the intended CPU)
...
#define USB_OTG_ENABLE                  _U1OTGCON_OTGEN_MASK
#define USB_OTG_DPLUS_ENABLE            _U1OTGCON_DPPULUP_MASK
...
//STALLIE, IDLEIE, TRNIE, and URSTIE are all enabled by default and are required
    ...
    #define USBEnableInterrupts() {\
        ...
        IPC7SET = (1 << _IPC7_USBIP_POSITION);\
...
#define USBDisableInterrupts()      {IEC1CLR = _IEC1_USBIE_MASK;}

#if defined(USB_INTERRUPT)
    #define USBMaskInterrupts()     {IEC1CLR = _IEC1_USBIE_MASK;}
    #define USBUnmaskInterrupts()   {IEC1SET = _IEC1_USBIE_MASK;}
#else
...
#define ConvertToVirtualAddress(a)    PA_TO_KVA1(a)
        ...
        #define _ClearUSBIF()   {IFS1CLR = _IFS1_USBIF_MASK;}
        #define _SetUSBIE()     {IEC1SET = _IEC1_USBIE_MASK;}    
...
U1CNFG1 = USB_SPEED_OPTION; \
U1EIE = _U1EIE_BTSEE_MASK | _U1EIE_BTOEE_MASK | _U1EIE_DFN8EE_MASK | _U1EIE_CRC16EE_MASK | _U1EIE_CRC5EE_EOFEE_MASK | _U1EIE_PIDEE_MASK; \
U1IE = _U1IE_STALLIE_MASK | _U1IE_IDLEIE_MASK | _U1IE_TRNIE_MASK | _U1IE_URSTIE_DETACHIE_MASK | USB_SOF_INTERRUPT | USB_ERROR_INTERRUPT; \
U1OTGCON = 0x0000; \
}
...
/*
#define SetConfigurationOptions()       { \
U1OTGCONCLR = _U1OTGCON_OTGEN_MASK; \
}
*/
