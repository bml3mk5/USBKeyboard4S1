...
{
    { INIT_CL_SC_P( 3ul, 1ul, 1ul ), 0, 0, {TPL_CLASS_DRV} }, // (HID keyboard)
    { INIT_CL_SC_P( 3ul, 0ul, 0ul ), 0, 0, {TPL_CLASS_DRV} }, // (HID null)
    { INIT_CL_SC_P( 9ul, 0ul, 0ul ), 0, 1, {TPL_CLASS_DRV} } // (HUB)
};
