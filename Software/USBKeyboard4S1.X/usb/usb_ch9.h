...
typedef union __attribute__ ((packed)) _USB_DEVICE_DESCRIPTOR
{
    ...
    uint8_t b[18];                      // Default size is 18bytes
...
*/
typedef union __attribute__ ((packed)) _USB_CONFIGURATION_DESCRIPTOR
{
    struct {
        uint8_t bLength;               // Length of this descriptor.
    ...
    uint8_t b[9];                      // Default size is 9bytes
...
*/
typedef union __attribute__ ((packed)) _USB_INTERFACE_DESCRIPTOR
{
    struct {
        uint8_t bLength;               // Length of this descriptor.
...
*/
typedef union __attribute__ ((packed)) _USB_ENDPOINT_DESCRIPTOR
{
    struct {
        uint8_t bLength;               // Length of this descriptor.
    ...
    uint8_t b[7];                      // Default size is 7bytes
